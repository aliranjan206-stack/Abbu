...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003853500447').split()]  # Channel id for auto indexing (make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/pratilipifm0900')  # Support group link (make sure bot is admin)
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0xzzz") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'royal_fileees') # Collection name (default: dreamcinezone_files)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003814751875')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003814751875')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
